...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactFavicon = __webpack_require__(159);
	
	var _reactFavicon2 = _interopRequireDefault(_reactFavicon);
	
	var _CheckoutForm = __webpack_require__(160);
	
	var _CheckoutForm2 = _interopRequireDefault(_CheckoutForm);
	
	var _checkout_form = __webpack_require__(169);
	
	var _checkout_form2 = _interopRequireDefault(_checkout_form);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PersonalDetails = __webpack_require__(161);
	
	var _PersonalDetails2 = _interopRequireDefault(_PersonalDetails);
	
	var _AddressDetails = __webpack_require__(163);
	
	var _AddressDetails2 = _interopRequireDefault(_AddressDetails);
	
	var _CheckoutButton = __webpack_require__(166);
	...
	var _GoogleMapHelper = __webpack_require__(168);
	
	var _GoogleMapHelper2 = _interopRequireDefault(_GoogleMapHelper);
	...
	var CheckoutForm = function (_React$Component) {
	  ...
	  function CheckoutForm() {
	    ...
	    var _this = _possibleConstructorReturn(this, (CheckoutForm.__proto__ || Object.getPrototypeOf(CheckoutForm)).call(this));
	
	    _this.validations = [['first_name', _Validator2.default.notBlank], ['last_name', _Validator2.default.notBlank], ['email', _Validator2.default.notBlank], ['phone', _Validator2.default.notBlank], ['country', _Validator2.default.notBlank], ['city', _Validator2.default.notBlank], ['post_code', _Validator2.default.notBlank], ['house_number', _Validator2.default.notBlank], ['address', _Validator2.default.notBlank], ['additional_info', _Validator2.default.none], ['latitude', _Validator2.default.none], ['longitude', _Validator2.default.none]];
	    ...
	    _this.validations.forEach(function (validation) {
	      var fieldName = validation[0];
	      _this.state[fieldName] = "";
	    });
	
	    _this.handleUpdate = _this.handleUpdate.bind(_this);
	    _this.handleCheckoutClicked = _this.handleCheckoutClicked.bind(_this);
	    return _this;
	  }
	
	  _createClass(CheckoutForm, [{
	    key: 'handleUpdate',
	    value: function handleUpdate(fieldName, newValue) {
	      ...
	      if (fieldName === 'post_code') {
	        ...
	        var phoneOnlyLegalChars = /^[\d()]+$/.test(newValue);
	      ...
	      var newInvalidFields = this.state.invalid_fields.slice(0);
	      var fieldNameIndex = newInvalidFields.indexOf(fieldName);
	    ...
	    key: 'fetchAddressForPostCode',
	    value: function fetchAddressForPostCode(postCode) {
	      var _this2 = this;
	
	      this.setState({
	        address_loading: true
	      });
	      _GoogleMapHelper2.default.fetchDetailsForPostCode(postCode, function (addressDetails) {
	        var stateDiff = addressDetails;
	        stateDiff.post_code = postCode;
	        stateDiff.address_loading = false;
	        _this2.setState(stateDiff);
	      });
	    }
	  }, {
	    key: 'handleCheckoutClicked',
	    value: function handleCheckoutClicked(ev) {
	      var _this3 = this;
	
	      ev.preventDefault();
	      var newInvalidFields = [];
	      this.validations.forEach(function (validation) {
	        var field = validation[0];
	        var validator = validation[1];
	        var value = _this3.state[field];
	        if (!validator(value)) newInvalidFields.push(field);
	      });
	      var checkoutSuccessfull = newInvalidFields.length === 0;
	      this.setState({
	    ...
	    value: function render() {
	      var completeNotifcation = "Checkout Form";
	      if (this.state.checkout_successfull) {
	        completeNotifcation = _react2.default.createElement(
	          'span',
	          { className: 'final' },
	          'Checkout Complete'
	        );
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          null,
	          _react2.default.createElement(_PersonalDetails2.default, {
	          ...
	          _react2.default.createElement(_AddressDetails2.default, {
	          ...
	          _react2.default.createElement(_CheckoutButton2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _InputWithIcon = __webpack_require__(162);
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'input-group' },
	          _react2.default.createElement(_InputWithIcon2.default, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputWithIcon = function (_React$Component) {
	  _inherits(InputWithIcon, _React$Component);
	
	  function InputWithIcon() {
	    _classCallCheck(this, InputWithIcon);
	
	    var _this = _possibleConstructorReturn(this, (InputWithIcon.__proto__ || Object.getPrototypeOf(InputWithIcon)).call(this));
	
	    _this.handleUpdate = _this.handleUpdate.bind(_this);
	    _this.resetPlaceholderText = _this.resetPlaceholderText.bind(_this);
	    return _this;
	  }
	
	  _createClass(InputWithIcon, [{
	    key: "handleUpdate",
	    ...
	    key: "resetPlaceholderText",
	    value: function resetPlaceholderText(ev) {
	    ...
	    value: function render() {
	      ...
	      if (this.props.imageName) {
	        ...
	        }, _defineProperty(_style, "backgroundSize", "16px 16px"), _defineProperty(_style, "paddingLeft", "45px"), _style);
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _CountrySelect = __webpack_require__(164);
	...
	var AddressDetails = function (_React$Component) {
	  _inherits(AddressDetails, _React$Component);
	
	  function AddressDetails() {
	    _classCallCheck(this, AddressDetails);
	
	    var _this = _possibleConstructorReturn(this, (AddressDetails.__proto__ || Object.getPrototypeOf(AddressDetails)).call(this));
	
	    _this.handleCountrySelected = _this.handleCountrySelected.bind(_this);
	    _this.handleAdditionalInfoUpdate = _this.handleAdditionalInfoUpdate.bind(_this);
	    return _this;
	  }
	
	  _createClass(AddressDetails, [{
	    key: 'handleCountrySelected',
	    value: function handleCountrySelected(ev) {
	      console.log("ev", ev.target.value);
	      this.props.onUpdate('country', ev.target.value);
	    }
	  }, {
	    key: 'handleAdditionalInfoUpdate',
	    value: function handleAdditionalInfoUpdate(ev) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'input-group' },
	          _react2.default.createElement(_CountrySelect2.default, {
	...
	exports.default = AddressDetails;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _XmlHttpHelper = __webpack_require__(165);
	
	var _XmlHttpHelper2 = _interopRequireDefault(_XmlHttpHelper);
	...
	var CountrySelect = function (_React$Component) {
	  ...
	  function CountrySelect() {
	    ...
	    var _this = _possibleConstructorReturn(this, (CountrySelect.__proto__ || Object.getPrototypeOf(CountrySelect)).call(this));
	  ...
	  _createClass(CountrySelect, [{
	    ...
	    value: function componentDidMount() {
	      ...
	      var url = 'data/country_names.json';
	      _XmlHttpHelper2.default.get(url, function (countries) {
	        _this2.setState({
	          countries: countries
	        });
	      });
	    ...
	    value: function render() {
	      ...
	      options.unshift(_react2.default.createElement(
	        'option',
	        { key: 'please-select', value: '', disabled: true },
	        defaultText
	      ));
...
/***/ function(module, exports) {
	...
	var XmlHttpHelper = {
	  get: function get(url, onloadCallback) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CheckoutButton = function (_React$Component) {
	  ...
	  function CheckoutButton() {
	    ...
	    return _possibleConstructorReturn(this, (CheckoutButton.__proto__ || Object.getPrototypeOf(CheckoutButton)).apply(this, arguments));
	  }
...
/***/ function(module, exports) {
	...
	var Validator = {
	  notBlank: function notBlank(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GoogleMapParser = {
	  ...
	  fetchDetailsForPostCode: function fetchDetailsForPostCode(postCode, callback) {
	    var _this = this;
	
	    if (postCode.replace(' ', '').length >= 6) {
	      var url = "https://maps.googleapis.com/maps/api/geocode/json?address=" + postCode;
	      _XmlHttpHelper2.default.get(url, function (responseObject) {
	        var status = responseObject.status;
	        if (status !== "OK") {
	          console.log("Reverse geocoding error:", responseObject.status);
	          callback(_this.blankResponse);
	        } else {
	          var addressDetails = _this.parseResponse(responseObject);
	  ...
	  parseResponse: function parseResponse(responseObject) {
	    ...
	    var countryComponent = this.getAddressComponent(addressComponents, 'country');
	    var cityComponent = this.getAddressComponent(addressComponents, 'postal_town');
	    return {
	      address: address,
	      latitude: latitude,
	      longitude: longitude,
	  ...
	  getAddressComponent: function getAddressComponent(addressComponents, type) {
	...
	exports.default = GoogleMapParser;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./checkout_form.less", function() {
				var newContent = require("!!./../node_modules/css-loader/index.js!./../node_modules/less-loader/index.js!./checkout_form.less");
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  font-size: 20px;\n  font-family: 'Quicksand', sans-serif;\n  color: #444;\n}\nbody {\n  background: #B7B4FC;\n  background: -webkit-linear-gradient(#B7B4FC, #594684);\n  background: -o-linear-gradient(#B7B4FC, #594684);\n  background: -moz-linear-gradient(#B7B4FC, #594684);\n  background: linear-gradient(#B7B4FC, #594684);\n}\nh1 {\n  font-size: 30px;\n  background-color: #F1F2F8;\n  padding: 30px;\n}\ninput,\nselect,\ntextarea,\nbutton {\n  background-color: white;\n  border: 2px #DDDDDD solid;\n  border-radius: 0px;\n  flex-grow: 2;\n  flex-shrink: 2;\n  -webkit-appearance: none;\n  -webkit-border-radius: 0px;\n  flex-basis: 20%;\n  padding: 5px 11px;\n  margin: 10px;\n  width: 100px;\n}\nbutton {\n  width: auto;\n}\nbutton:not([disabled]):hover,\nselect:not([disabled]):hover {\n  background-color: #EFEFEF;\n  cursor: pointer;\n}\nbutton:active {\n  background-color: #E0E0E0;\n}\nselect {\n  width: 200px;\n}\ntextarea {\n  resize: none;\n}\n.section-container {\n  background-color: #F9F7FD;\n  border-top: 1px #DDDDDD solid;\n  width: 560px;\n  padding: 20px;\n}\n.input-group {\n  display: flex;\n}\n.invalid {\n  border-color: tomato;\n}\n.checkout-successfull,\nbutton.checkout-successfull:hover {\n  background: #B7B4FC;\n  border-color: #594684;\n  color: #594684;\n}\n.final {\n  border-color: #B7B4FC;\n  color: #594684;\n  font-weight: bold;\n}\n#main-container {\n  margin: 40px auto;\n  width: 600px;\n  box-shadow: 10px 10px 5px rgba(0, 0, 0, 0.2);\n}\n#additional-info {\n  height: 200%;\n}\n", ""]);
